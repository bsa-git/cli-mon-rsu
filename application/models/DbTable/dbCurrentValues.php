...
/**
 * Класс работы с таблицей values_сurrent базы данных DB
 *
 * @uses       Model_DBCommon
 * @package    cli-azot-m5
 * @subpackage Model
 */
class Model_DbTable_CurrentValues extends Model_DBCommon {
    ...
    public function __construct() {
        //Получим адаптер
        parent::__construct (array('name'=>"values_current",'adapter'=>'DB'));
    }
