...
/**
 * Модуль взаимодействия с классом Model_CurrentData
 * и базой данных DB
 *
...
class Model_CurrentDataMapper {
    ...
    public function getDbTable() {
        if (null === $this->_dbTable) {
            $this->setDbTable('Model_DbTable_CurrentData');
        }
    ...
    public function save(Model_CurrentData $aObject) {
    ...
    public function fetchAll() {
        ...
        while ($arrResult = $res->Fetch()) {
            $oObject = new Model_CurrentData($arrResult);
            $arrObjects[] = $oObject;
        }
    ...
    public function fetch(Model_CurrentData $aObject) {
